# Technical Details: Qestit QRM ATML
...
|-----------|---------|--------|
| `dateTimeFormat` | `yyyy-MM-ddTHH:mm:ss.FFFFZ` | <!-- TODO: describe effect --> |
| `cultureInfo` | `da-DK` | <!-- TODO: describe effect --> |
| `operationTypeCode` | `50` | <!-- TODO: describe effect --> |
| `replaceApostropheWithDotInRevision` | `true` | <!-- TODO: describe effect --> |
| `GT` | `LT` | <!-- TODO: describe effect --> |
| `GE` | `LE` | <!-- TODO: describe effect --> |
